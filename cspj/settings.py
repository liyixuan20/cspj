"""
Django settings for cspj project.
...
SECRET_KEY = 'django-insecure-ub#6*ta+xnr5fs*)3feev0+!a@^1x0#e9**8@#j++xn9g5#!^y'
...
WSGI_APPLICATION = 'cspj.wsgi.application'
